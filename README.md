...
- [`docs`](https://github.com/ixkaito/NotoSerifCJKjp-subset/tree/master/demo): デモのソースファイル

## ファイルサイズの比較

|| オリジナル | [Google 版サブセット](https://www.google.com/get/noto/help/cjk/) | ixkaito/NotoSerifCJKjp-subset (OTF / WOFF) |
|---|---:|---:|---:|
